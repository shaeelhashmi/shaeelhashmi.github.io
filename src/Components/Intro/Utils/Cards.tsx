...
export default function Cards({ children,className,duration,scaleX }: CardsProps) {
    ...
    return (
        <div className={`relative  w-full rounded-xl ${isDarkMode ? "bg-[#06011c]" : "bg-[#deddfd] dark-mode"} md:after:w-[105%] md:after:h-[105%] after:w-[103%] after:h-[103%] h-full  ${className || ''} `}>
