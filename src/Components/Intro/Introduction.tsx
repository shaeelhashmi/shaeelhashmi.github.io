    ...
    <section  id="about" data-translate="translate-x-64" ref={aboutRef}>
      ...
      <div className="mt-5 space-y-4">
       <div className=" backdrop-blur-md  bg-[#402d9513] rounded-lg xs:p-3 p-2">
        <h2 className="font-subheading xs:text-2xl text-xl font-semibold text-left">Full-stack websites</h2>
       ...
       <div className="backdrop-blur-md  bg-[#402d9513] rounded-lg xs:p-3 p-2">
  <h2 className="font-subheading xs:text-2xl text-xl font-semibold text-left">Website scrapers</h2>
