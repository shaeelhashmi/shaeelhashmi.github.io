...
export default function Project() {
  return (
    <div className="flex items-center justify-center w-full md:my-12 font-franklin my-5" >
       ...
       <div className="flex-shrink-0 mx-5"><ProjectBox description="A real-time chat application that allows users to exchange messages instantly, manage friend requests, and store user information securely for ongoing access of usedr data." Title='Chat application'   Link="https://github.com/shaeelhashmi/Chat-application"  SVG={[Ts,Tailwind,ReactSVG, GoSvg,MySql]} image={"https://cdn.jsdelivr.net/gh/shaeelhashmi/shaeelhashmi.github.io/src/asset/Images/smartphone-8930867.jpg"}/></div>
