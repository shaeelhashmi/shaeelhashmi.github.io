...
export default function Hero() {
  ...
  return (
    ...
    <div className="flex xl:items-start items-center justify-center w-full flex-col min-h-[300px] mt-10">
        ...
        xl:bg-clip-text xl:text-transparent xl:bg-gradient-to-r font-heading 2xl:text-start text-center z-20 ${isDarkMode
    ? 'from-blue-300 via-white to-blue-300'
    : 'from-blue-600 via-gray-900 to-blue-600'
}`}> Shaeel  Hashmi</h1>
         <ReactTyped
    className="text-2xl sm:text-3xl  font-medium w-3/4 2xl:text-start text-center font-times  z-20  h-10"
      strings={[
