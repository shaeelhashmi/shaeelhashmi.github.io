...
export default function Footer(props: FooterProps) {
  ...
  return (
    <footer className={`h-[220px]  overflow-hidden flex flex-col items-center justify-center text-center transition-all duration-1000  ${footerAppeared ?`${isDarkMode?"shadow-[0_0_10px_2px_rgba(255,255,255)]":"shadow-[0_0_10px_2px_rgba(0,0,0,0.5)]"}`:"shadow-invinsible opacity-0"} `}>
    <div
      className={`h-full w-full translate-y-64    space-y-4 pt-6 `}
      ref={footerRef}
      style={{
