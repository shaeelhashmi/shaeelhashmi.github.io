...
export default function ProjectBox(props:props) {
  ...
  return (
    <div className="md:w-[200px] xs:w-[220px] w-[200px] h-[270px]   flex flex-col justify-between  transition-all duration-700  z-10  bg-[#a700ef1a] "  >      
        <div >
        <h1 className="font-bold text-center text-xl h-[50px] mb-2">{props.Title}</h1>
        </div>
        <div className="h-full p-2 ">
        <p className="xs:text-sm text-xs sm:text-sm"  style={{ textShadow: isDarkMode?'0 0 1px white':  '0 0 1px black'}}>{props.description}</p>
        </div>
